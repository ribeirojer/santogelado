    ...
    <>
      ...
      <main className="w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div className="container text-justify pt-28 mx-auto">
          ...
          <p className="italic text-xl md:text-2xl text-gray-300 leading-relaxed mb-12 text-center">
        ...
        <div className="container text-justify mx-auto">
          ...
          <div className="grid grid-cols-1  md:grid-cols-2 gap-4">
            <ul>
              <li>
                <a
                  ...
                  className="flex items-center justify-center border p-2 mt-2 border-yellow-500 hover:bg-yellow-500 hover:text-black text-white"
                >
                  <svg
            ...
            <ul>
              <li>
                <a
                  href="mailto:contato@santogeladodrinks.com"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center border p-2 mt-2 border-yellow-500 hover:bg-yellow-500 hover:text-black text-white"
                >
