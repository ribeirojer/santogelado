...
const Header: React.FC<Props> = (props) => {
  return (
    <header id="header" className="header fixed top-0">
      <div className="container-fluid flex items-center justify-between">
        <Link href="/" className="logo flex items-center me-auto me-lg-0">
          <svg
          ...
          <ul>
            ...
            <li className="dropdown">
              ...
              <ul>
                ...
                <li>
                  <Link href="/gallery/people">People</Link>
                </li>
                <li>
                  <Link href="/gallery/architecture">Architecture</Link>
                </li>
                <li>
                  <Link href="/gallery/animals">Animals</Link>
                </li>
                <li>
                  <Link href="/gallery/sports">Sports</Link>
                </li>
                <li>
                  <Link href="/gallery/travel">Travel</Link>
                </li>
                <li className="dropdown">
                  <a href="#">
                    <span>Sub Menu</span>{" "}
        ...
        <svg
          ...
          width="24"
          height="24"
          className="mobile-nav-toggle mobile-nav-hide hidden bi bi-x"
          viewBox="0 0 24 24"
          // style="fill: rgba(0, 0, 0, 1);transform: ;msFilter:;"
        >
